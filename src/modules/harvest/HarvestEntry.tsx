  ...
  return (
    <div className="h-auto min-h-full md:h-full flex flex-col space-y-4 page-transition overflow-visible md:overflow-hidden bg-background p-6 pb-10 md:pb-6">
      ...
      <div className="flex-1 overflow-y-auto lg:overflow-hidden min-h-0 relative no-scrollbar">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:h-full h-auto">
          {/* Form Column */}
          <div className="lg:col-span-6 lg:h-full h-auto">
            <form onSubmit={handleSave} className="bg-white p-4 rounded-2xl border border-slate-100/50 shadow-premium space-y-3 relative group lg:h-full h-auto flex flex-col overflow-visible lg:overflow-hidden">
              {/* Decoration */}
          ...
          {/* History Column */}
          <div className="lg:col-span-6 flex flex-col lg:h-full h-auto min-h-0">
